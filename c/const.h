...
/**
 * @brief The 16 bytes array used in the MixColumns process (a(x) = {03}x3 + {01}x2 + {01}x + {02})
*/
const byte a_x_mixColumns[16] = {0x02, 0x03, 0x01, 0x01, 0x01, 0x02, 0x03, 0x01, 0x01, 0x01, 0x02, 0x03, 0x03, 0x01, 0x01, 0x02};

/**
 * @brief The 16 bytes array used in the InverseMixColumns process (a-1(x) = {0b}x3 + {0d}x2 + {09}x + {0e})
*/
